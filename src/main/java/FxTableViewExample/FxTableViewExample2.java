...
public class FxTableViewExample2
	...
	public void start(Stage primaryStage) {
		...
		titleCol.setOnEditCommit(new EventHandler<CellEditEvent<MyBook, String>>() {
			@Override
			public void handle(CellEditEvent<MyBook, String> t) {

				((MyBook) t.getTableView().getItems().get(
		...
		authorCol.setOnEditCommit(new EventHandler<CellEditEvent<MyBook, String>>() {
			@Override
			public void handle(CellEditEvent<MyBook, String> t) {
	...
	private class DeleteButtonListener implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent e) {
			...
			MyBook book = (MyBook) table.getSelectionModel().getSelectedItem();
			data.remove(ix);
